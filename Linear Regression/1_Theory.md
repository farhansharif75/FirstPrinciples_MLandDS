We first cover the theory behind the Linear Regression (LR) model. The Wikipedia page for the LR model provides a suitable introduction to the mathematical formulation of this model.
